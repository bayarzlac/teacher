...
@section('subcontent')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 lg:col-span-6">
            <form class="validate-form-teacher" action="{{ route('teacher-aguulga-save') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="intro-y box p-5">
                    ...
                    <div class="input-form mt-3">
                        ...
                        <textarea name="tailbar" class="input w-full border mt-2"></textarea>
                    </div>
